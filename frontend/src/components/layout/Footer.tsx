...
const navigation = {
  ...
  social: [
    {
      name: 'Twitter',
      href: 'https://twitter.com/DataPeritus',
      icon: (props: any) => (
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/muhsinmuhammad/Cars360',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/muhsinmuhammad/',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        ...
        <div className="mx-auto max-w-7xl px-6 py-6 lg:px-8">
          <div className="md:flex md:items-center md:justify-between">
            <div className="text-sm text-gray-600">
              <p>&copy; 2024 Cars360. All rights reserved.</p>
              <p className="mt-1">
                Built on{' '}
                <a
